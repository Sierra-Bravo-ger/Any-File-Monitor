...
$allowedHosts = @("afmdemo.madmoench.de", "192.168.178.45")
...
# Start-AFM-Dashboard_restricted.ps1
...
if ($ExternalAccess -and $ipAddresses) {
    ...
    Write-Host "  http://afmdemo.madmoench.de:$port/index.html (mit korrektem DNS-Eintrag)" -ForegroundColor Green
